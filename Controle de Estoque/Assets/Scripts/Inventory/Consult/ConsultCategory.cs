...
namespace Assets.Scripts.Inventory.Consult
{
    public class ConsultCategory
    {
        ...
        /// <summary>
        /// Find all itens from a specific category that match the search parameters using TMP_InputFieds
        /// </summary>
        public Sheet FindItens(List<int> activeIndexes, TMP_InputField[] categorySearchInputs, Sheet databaseToConsult, List<string> operators)
        {
            ...
            ConsultCategoryHelperMethods consultCategoryHelperMethods = new ConsultCategoryHelperMethods();
        ...
        /// <summary>
        /// Find all itens from a specific category that match the search parameters using TextFields
        /// </summary>
        public Sheet FindItens(List<int> activeIndexes, TextField[] categorySearchInputs, Sheet databaseToConsult, List<string> operators)
        {
            Sheet returnSheet = new Sheet();
            returnSheet.itens.Clear();
            ConsultCategoryHelperMethods consultCategoryHelperMethods = new ConsultCategoryHelperMethods();
