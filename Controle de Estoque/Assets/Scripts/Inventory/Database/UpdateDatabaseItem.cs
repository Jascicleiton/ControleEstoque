    ...
    public static void UpdateItem(List<string> parameters, int itemIndexFullDatabase)
    {
        ...
        switch (itemToUpdate.Categoria)
        {
            ...
            case ConstStrings.C_AdaptadorAC:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.adaptadorAC, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_Carregador:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.carregador, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_Desktop:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.desktop, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_Fonte:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.fonte, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_HD:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.hd, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_Idrac:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.idrac, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_Memoria:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.memoria, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_Monitor:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.monitor, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_Notebook:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.notebook, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_PlacaControladora:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.placaControladora, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_PlacaDeCapturaDeVideo:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.placaDeCapturaDeVideo, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_PlacaDeRede:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.placaDeRede, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_PlacaDeSom:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.placaDeSom, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_PlacaDeVideo:
                ...
                itemToUpdate.QuaisConexoes = parameters[12];
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.placaDeVideo, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_Processador:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.processador, itemToUpdate.Patrimonio);
                ...
                switch (InternalDatabase.Instance.currentEstoque)
                {
                    ...
                    default:
                        ...
                        break;
                                ...
                                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.roteador, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_Servidor:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.servidor, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_StorageNAS:
                ...
                itemToUpdate.CapacidadeMaxHD = parameters[14];
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.storageNAS, itemToUpdate.Patrimonio);
            ...
            case ConstStrings.C_Switch:
                ...
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.Switch, itemToUpdate.Patrimonio);
            ...
            default:
                categoryItemToUpdateIndex = ConsultDatabase.Instance.GetCategoryItemIndex(InternalDatabase.outros, itemToUpdate.Patrimonio);
