...
public class MovementManager : MonoBehaviour
{
    ...
    private IEnumerator CheckIfItemExists()
    {
        ...
        if (itemInformationDP.value == 0)
        {
            ...
            WWWForm consultPatrimonioForm = CreateForm.GetConsultPatrimonioForm(itemInformationInput.text);
        ...
        else if (itemInformationDP.value == 1)
        {
            ...
            WWWForm consultSerialForm = CreateForm.GetConsultSerialForm(itemInformationInput.text);
    ...
    private IEnumerator MoveItem()
    {
        ...
        if (itemInformationDP.value == 0)
        {
            moveItemForm = CreateForm.GetMoveItemForm(itemInformationInput.text, itemToChange.Serial, UsersManager.Instance.currentUser.username, DateTime.Now.ToString("ddMMyyyy"), fromInput.text, toInput.text);
        }
        else if (itemInformationDP.value == 1)
        {
            moveItemForm = CreateForm.GetMoveItemForm(itemToChange.Patrimonio, itemInformationInput.text, UsersManager.Instance.currentUser.username, DateTime.Now.ToString("ddMMyyyy"), fromInput.text, toInput.text);
        }
