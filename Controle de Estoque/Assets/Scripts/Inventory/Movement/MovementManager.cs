...
namespace Assets.Scripts.Inventory.Movement
{
    public class MovementManager : MonoBehaviour
    {
        ...
        ConsultDatabase _consultDatabaseReference;
        ...
        private IEnumerator CheckIfItemExists()
        {
            ...
            {
                _itemToChange = _consultDatabaseReference.ConsultPatrimonio(_tempInt, InternalDatabase.Instance.fullDatabase);
            }
            else
            {
        ...
        private IEnumerator MoveItem()
        {
            ...
            if (HandlePostRequestResponse.HandleWebRequest(createPostRequest))
            {
                ...
                _itemToChangeIndex = _consultDatabaseReference.GetItemIndex();
                UpdateItemToChange();
                UpdateDatabase();
                createPostRequest.Dispose();
                MouseManager.Instance.SetDefaultCursor();
