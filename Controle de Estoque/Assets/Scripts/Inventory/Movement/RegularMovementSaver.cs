...
namespace Assets.Scripts.Inventory.Movement
{
    ...
    {
        [SerializeField] private List<MovementRecords> _regularRecords = new List<MovementRecords>();
        ...
        public void RegisterNewRegularMovement(MovementRecords newMovement)
        {
            if (newMovement != null)
            {
                _regularRecords.Add(newMovement);
            }
            else
            {
        ...
        public JToken CaptureAsJToken()
        {
            ...
            foreach (var item in _regularRecords)
            {
            ...
            if (state is JArray stateArray)
            {
                ...
                foreach (var item in stateList)
                {
                    if (item is JObject itemState)
                    {
                        ...
                        _regularRecords.Add(regularMovementToLoad);
                    }
                }
            }
        }
