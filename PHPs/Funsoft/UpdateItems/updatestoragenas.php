...
$updateQuery = "UPDATE Storage_NAS SET Modelo = '".$modelo."', Tamanho_HD = '".$tamanhohd."', Tipos_de_RAID  = '".$tiporaid."', Tipo_de_HD = '".$tipohd."', Capacidade_max_hd = '".$capacidademaxhd."', Ate_quantos_HDs = '".$quantoshd."';";
